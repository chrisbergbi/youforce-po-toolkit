...
- Als `latest_version` == `installed_version`: zeg "Je plugin is up-to-date (v0.11.0)." Stop.
...
Bij elke nieuwe release: vervang `0.11.0` (twee keer) door het nieuwe versienummer.
